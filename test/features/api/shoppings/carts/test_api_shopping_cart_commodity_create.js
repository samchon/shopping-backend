...
exports.test_api_shopping_cart_commodity_create = void 0;
...
const test_api_shopping_cart_commodity_create = async (pool) => {
    ...
    e2e_1.TestValidator.equals("index", commodity, page.data[0]);
    const read = await index_1.default.functional.shoppings.customers.carts.commodities.at(pool.customer, commodity.id);
    e2e_1.TestValidator.equals("read", commodity, read);
};
exports.test_api_shopping_cart_commodity_create = test_api_shopping_cart_commodity_create;
//# sourceMappingURL=test_api_shopping_cart_commodity_create.js.map