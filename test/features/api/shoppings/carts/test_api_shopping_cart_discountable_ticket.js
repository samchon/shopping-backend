...
exports.test_api_shopping_cart_discountable_ticket = void 0;
...
exports.test_api_shopping_cart_discountable_ticket = (0, validate_api_shopping_cart_discountable_1.validate_api_shopping_cart_discountable)(async (pool, props) => {
    await e2e_1.ArrayUtil.asyncMap(props.coupons, (coupon) => index_1.default.functional.shoppings.customers.coupons.tickets.create(pool.customer, {
        coupon_id: coupon.id,
    }));
...
//# sourceMappingURL=test_api_shopping_cart_discountable_ticket.js.map