...
exports.test_api_shopping_delivery_journey_create = void 0;
...
const test_api_shopping_delivery_journey_create = async (pool) => {
    ...
    const inputList = ["preparing", "manufacturing", "delivering"].map((type) => ({
        type,
        title: null,
        description: null,
    ...
    const journeys = await e2e_1.ArrayUtil.asyncMap(inputList, (input) => index_1.default.functional.shoppings.sellers.deliveries.journeys.create(pool.seller, delivery.id, input));
    e2e_1.TestValidator.equals("create", inputList, journeys);
    const reloaded = await index_1.default.functional.shoppings.sellers.orders.at(pool.seller, order.id);
    e2e_1.TestValidator.equals("journeys", reloaded.publish.deliveries[0].journeys, journeys);
};
exports.test_api_shopping_delivery_journey_create = test_api_shopping_delivery_journey_create;
//# sourceMappingURL=test_api_shopping_delivery_journey_create.js.map