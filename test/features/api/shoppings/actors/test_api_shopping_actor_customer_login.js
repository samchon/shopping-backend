...
exports.test_api_shopping_actor_customer_login = void 0;
...
const test_api_shopping_actor_customer_login = async (pool) => {
    const joined = await (0, test_api_shopping_actor_customer_join_1.test_api_shopping_actor_customer_join)(pool);
    const guest = await (0, test_api_shopping_actor_customer_create_1.test_api_shopping_actor_customer_create)(pool);
    e2e_1.TestValidator.equals("guest.member", guest.member, null);
    const passed = await index_1.default.functional.shoppings.customers.authenticate.login(pool.customer, {
...
exports.test_api_shopping_actor_customer_login = test_api_shopping_actor_customer_login;
//# sourceMappingURL=test_api_shopping_actor_customer_login.js.map