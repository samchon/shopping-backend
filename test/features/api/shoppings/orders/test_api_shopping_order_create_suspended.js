...
exports.test_api_shopping_order_create_suspended = void 0;
...
const test_api_shopping_order_create_suspended = async (pool) => {
    ...
    await e2e_1.TestValidator.httpError("suspended", 422, () => (0, generate_random_order_1.generate_random_order)(pool, [commodity]));
};
exports.test_api_shopping_order_create_suspended = test_api_shopping_order_create_suspended;
//# sourceMappingURL=test_api_shopping_order_create_suspended.js.map