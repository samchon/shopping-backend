...
exports.test_api_shopping_order_create_paused = void 0;
...
const test_api_shopping_order_create_paused = async (pool) => {
    ...
    await e2e_1.TestValidator.httpError("paused", 422, () => (0, generate_random_order_1.generate_random_order)(pool, [commodity]));
};
exports.test_api_shopping_order_create_paused = test_api_shopping_order_create_paused;
//# sourceMappingURL=test_api_shopping_order_create_paused.js.map