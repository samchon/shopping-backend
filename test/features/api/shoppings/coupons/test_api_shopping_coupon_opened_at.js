...
exports.test_api_shopping_coupon_opened_at = void 0;
...
const test_api_shopping_coupon_opened_at = async (pool) => {
    ...
    const validate = async (path, visible) => {
        ...
        if (visible)
            ...
            await e2e_1.TestValidator.httpError("gone", 422, read);
    };
...
exports.test_api_shopping_coupon_opened_at = test_api_shopping_coupon_opened_at;
//# sourceMappingURL=test_api_shopping_coupon_opened_at.js.map