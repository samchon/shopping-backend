...
import { validate_api_shopping_sale_inquiry_comment_index_search } from "./internal/validate_api_shopping_sale_inquiry_comment_index_search";

export const test_api_shopping_sale_review_comment_index_search = async (
  pool: ConnectionPool,
): Promise<void> => {
  ...
  await validate_api_shopping_sale_inquiry_comment_index_search(
    pool,
    admin,
    customer,
    seller,
