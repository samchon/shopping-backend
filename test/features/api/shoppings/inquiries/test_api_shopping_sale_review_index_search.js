...
exports.test_api_shopping_sale_review_index_search = void 0;
...
const test_api_shopping_sale_review_index_search = async (pool) => {
    ...
    const total = await e2e_1.ArrayUtil.asyncRepeat(10, async () => {
        ...
        return (0, generate_random_sale_review_1.generate_random_sale_review)(pool, sale, good);
    });
    const expected = await index_1.default.functional.shoppings.customers.sales.reviews.index(pool.customer, sale.id, {
        limit: total.length,
    });
    ...
    await search({
        ...
        filter: (arc, [minimum, maximum]) => minimum <= arc.score && arc.score <= maximum,
    });
...
exports.test_api_shopping_sale_review_index_search = test_api_shopping_sale_review_index_search;
//# sourceMappingURL=test_api_shopping_sale_review_index_search.js.map