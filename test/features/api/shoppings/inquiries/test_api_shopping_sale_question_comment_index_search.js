...
exports.test_api_shopping_sale_question_comment_index_search = void 0;
...
const validate_api_shopping_sale_inquiry_comment_index_search_1 = require("./internal/validate_api_shopping_sale_inquiry_comment_index_search");
const test_api_shopping_sale_question_comment_index_search = async (pool) => {
    ...
    await (0, validate_api_shopping_sale_inquiry_comment_index_search_1.validate_api_shopping_sale_inquiry_comment_index_search)(pool, admin, customer, seller, sale, question);
};
exports.test_api_shopping_sale_question_comment_index_search = test_api_shopping_sale_question_comment_index_search;
//# sourceMappingURL=test_api_shopping_sale_question_comment_index_search.js.map