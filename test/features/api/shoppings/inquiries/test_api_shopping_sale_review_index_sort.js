...
exports.test_api_shopping_sale_review_index_sort = void 0;
...
const test_api_shopping_sale_review_index_sort = async (pool) => {
    ...
    const validator = e2e_1.TestValidator.sort("sort reviews", async (input) => {
    ...
    const components = [
        ...
        validator("score")(e2e_1.GaffComparator.numbers((x) => x.score)),
    ];
...
exports.test_api_shopping_sale_review_index_sort = test_api_shopping_sale_review_index_sort;
//# sourceMappingURL=test_api_shopping_sale_review_index_sort.js.map