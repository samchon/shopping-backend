...
export const test_api_shoppings_sellers_systematic_channels_categories_index =
  async (connection: api.IConnection) => {
    const output: Array<IShoppingChannelCategory.IHierarchical> =
      await api.functional.shoppings.sellers.systematic.channels.categories.index(
        connection,
        {
