...
export const test_api_shoppings_customers_systematic_channels_categories_index =
  async (connection: api.IConnection) => {
    const output: Array<IShoppingChannelCategory.IHierarchical> =
      await api.functional.shoppings.customers.systematic.channels.categories.index(
        connection,
        {
