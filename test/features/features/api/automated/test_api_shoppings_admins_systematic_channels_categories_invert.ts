...
export const test_api_shoppings_admins_systematic_channels_categories_invert =
  async (connection: api.IConnection) => {
    const output: IShoppingChannelCategory.IInvert =
      await api.functional.shoppings.admins.systematic.channels.categories.invert(
        connection,
        {
