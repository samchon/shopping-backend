...
export const test_api_shoppings_customers_sales_questions_index = async (
  connection: api.IConnection,
) => {
  const output: IPage<IShoppingSaleQuestion.ISummary> =
    await api.functional.shoppings.customers.sales.questions.index(connection, {
