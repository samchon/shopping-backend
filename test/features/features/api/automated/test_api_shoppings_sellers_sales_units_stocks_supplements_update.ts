...
export const test_api_shoppings_sellers_sales_units_stocks_supplements_update =
  async (connection: api.IConnection) => {
    const output =
      await api.functional.shoppings.sellers.sales.units.stocks.supplements.update(
        connection,
        {
