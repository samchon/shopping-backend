 ...
 * @path PATCH /shoppings/customers/orders/cart/:cartId/commodities/discountable
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace discountable {
    ...
    export const METADATA = {
        method: "PATCH",
        path: "/shoppings/customers/orders/cart/:cartId/commodities/discountable",
        request: {
            type: "application/json",
            encrypted: false
        },
    ...
    export const path = (cartId: null | string & Format<"uuid">): string => {
        return `/shoppings/customers/orders/cart/${encodeURIComponent(cartId ?? "null")}/commodities/discountable`;
    }
