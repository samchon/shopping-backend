...
/**
 * @controller ShoppingCustomerSaleReviewCommentsController.index
...
export namespace index {
    ...
    export const path = (saleId: string & Format<"uuid">, inquiryId: string & Format<"uuid">): string => {
        return `/shoppings/customers/sales/${encodeURIComponent(saleId ?? "null")}/reviews/${encodeURIComponent(inquiryId ?? "null")}/comments`;
    }
...
/**
 * @controller ShoppingCustomerSaleReviewCommentsController.at
...
export namespace at {
    ...
    export const path = (saleId: string & Format<"uuid">, inquiryId: string & Format<"uuid">, id: string & Format<"uuid">): string => {
        return `/shoppings/customers/sales/${encodeURIComponent(saleId ?? "null")}/reviews/${encodeURIComponent(inquiryId ?? "null")}/comments/${encodeURIComponent(id ?? "null")}`;
    }
...
/**
 * @controller ShoppingCustomerSaleReviewCommentsController.create
...
/**
 * @controller ShoppingCustomerSaleReviewCommentsController.update
...
/**
 * @controller ShoppingCustomerSaleReviewCommentsController.erase
 * @path DELETE /shoppings/customers/sales/:saleId/reviews/:inquiryId/comments/:id
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
