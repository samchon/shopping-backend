...
export namespace index {
  ...
  export const path = (channelCode: string) =>
    `/shoppings/sellers/systematic/channels/${encodeURIComponent(channelCode ?? "null")}/categories`;
  export const random = (
...
export namespace at {
  ...
  export const path = (channelCode: string, id: string & Format<"uuid">) =>
    `/shoppings/sellers/systematic/channels/${encodeURIComponent(channelCode ?? "null")}/categories/${encodeURIComponent(id ?? "null")}`;
  export const random = (
    g?: Partial<typia.IRandomGenerator>,
...
export namespace invert {
  ...
  export const path = (channelCode: string, id: string & Format<"uuid">) =>
    `/shoppings/sellers/systematic/channels/${encodeURIComponent(channelCode ?? "null")}/categories/${encodeURIComponent(id ?? "null")}/invert`;
  export const random = (
    g?: Partial<typia.IRandomGenerator>,
