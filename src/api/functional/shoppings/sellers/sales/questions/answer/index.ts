 ...
 * @path PUT /shoppings/sellers/sales/:saleId/questions/:questionId/answer/:id
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export async function update(
    ...
    return !!connection.simulate
        ...
        : PlainFetcher.fetch(
              ...
              {
                  ...update.METADATA,
                  path: update.path(saleId, questionId, id),
              } as const,
              input,
          );
}
export namespace update {
    ...
    export const METADATA = {
        method: "PUT",
        path: "/shoppings/sellers/sales/:saleId/questions/:questionId/answer/:id",
        request: {
            type: "application/json",
            encrypted: false
        },
    ...
    export const path = (saleId: string & Format<"uuid">, questionId: string & Format<"uuid">, id: string & Format<"uuid">): string => {
        return `/shoppings/sellers/sales/${encodeURIComponent(saleId ?? "null")}/questions/${encodeURIComponent(questionId ?? "null")}/answer/${encodeURIComponent(id ?? "null")}`;
    }
    ...
    export const simulate = async (
        ...
        const assert = NestiaSimulator.assert({
            method: METADATA.method,
            host: connection.host,
            path: path(saleId, questionId, id),
            contentType: "application/json",
        });
        assert.param("saleId")(() => typia.assert(saleId));
        assert.param("questionId")(() => typia.assert(questionId));
