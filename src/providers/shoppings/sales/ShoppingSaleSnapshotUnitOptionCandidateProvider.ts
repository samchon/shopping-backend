...
export namespace ShoppingSaleSnapshotUnitOptionCandidateProvider {
  export namespace json {
    export const transform = (
      input: Prisma.shopping_sale_snapshot_unit_option_candidatesGetPayload<ReturnType<typeof select>>
    ): IShoppingSaleUnitOptionCandidate => ({
      id: input.id,
      name: input.name,
    })
    export const select = () => ({} satisfies Prisma.shopping_sale_snapshot_unit_option_candidatesFindManyArgs)
  }
