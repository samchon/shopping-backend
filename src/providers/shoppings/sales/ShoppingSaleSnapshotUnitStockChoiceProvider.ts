...
export namespace ShoppingSaleSnapshotUnitStockChoiceProvider {
  export namespace json {
    export const transform = (
      input: Prisma.shopping_sale_snapshot_unit_stock_choicesGetPayload<ReturnType<typeof select>>
    ...
    export const select = () => ({} satisfies Prisma.shopping_sale_snapshot_unit_stock_choicesFindManyArgs)
  }
  ...
  export const collect = 
    ...
    (input: IShoppingSaleUnitStockChoice.ICreate, sequence: number) => {
      ...
      const candidate =
        option.candidates.create[input.candidate_index];
      return {
        id: v4(),
